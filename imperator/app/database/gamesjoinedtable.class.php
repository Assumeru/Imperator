	...
	public function create() {
		$this->getManager()->preparedStatement(
			'CREATE TABLE @GAMESJOINED (
				...
				@-GAMESJOINED.COLOR CHAR(6),
				@-GAMESJOINED.AUTOROL SMALLINT,
				@-GAMESJOINED.MISSION INT,
				@-GAMESJOINED.MISSION_USER INT,
				@-GAMESJOINED.STATE INT,
				@-GAMESJOINED.CARD_ARTILLERY SMALLINT,
				@-GAMESJOINED.CARD_CAVALRY SMALLINT,
				@-GAMESJOINED.CARD_INFANTRY SMALLINT,
				@-GAMESJOINED.CARD_JOKER SMALLINT,
